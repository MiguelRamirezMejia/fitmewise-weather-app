...
const WeatherResult = ({ data }) => {
  ...
  return (
    <div className="w-full p-6 bg-white rounded-2xl shadow-lg mt-8">
      ...
      <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {data.pronostico_5_dias.map((dia, index) => (
          <li key={index} className="bg-blue-50 rounded-xl p-4 shadow hover:shadow-md transition duration-300">
